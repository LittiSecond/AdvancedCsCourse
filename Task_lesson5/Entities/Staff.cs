...
namespace Task_lesson5.Entities
{
    ...
    class Staff
    {
        ...
        private Dictionary<int, Departament> _departamentList;
        /// <summary> Полный список сотрудников, включаяя нераспределённых  </summary>
        private Dictionary<int, Employee> _employeeList;
        /// <summary> Нераспределённые сотрудники </summary>
        private Dictionary<int, Employee> _notAllocatedEmployees;
        //LinkedList<Employee>
